...
export const metadata = {
  title: "AR Design Studio | QR Catalogue & AR Product Viewer for Local Businesses",
  description: "Create QR product catalogues, AR product previews, digital menus, WhatsApp lead pages, and campaign QR codes for shops, restaurants, furniture, jewellery, real estate, and local businesses.",
  alternates: {
    canonical: "https://ar.bsocio.in/"
  },
  openGraph: {
    title: "AR Design Studio | QR Catalogue & AR Product Viewer",
    description: "Create QR catalogues, AR product previews, WhatsApp enquiry pages, and digital product experiences for local businesses.",
  ...
  twitter: {
    ...
    title: "AR Design Studio | QR Catalogue & AR Product Viewer",
    description: "Create QR catalogues, AR product previews, WhatsApp enquiry pages, and AR product experiences.",
    images: ["https://ar.bsocio.in/og-image.jpg"]
  }
};
    ...
    <main className="min-h-screen bg-surface text-ink">
      ...
      <nav className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 px-5 py-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button href="/contact?source=nav" variant="light">View Demo</Button>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-5 pb-14 pt-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Button href="/contact?source=hero-demo" variant="accent">View Demo <ArrowRight size={18} /></Button>
            <WhatsAppButton>Talk on WhatsApp</WhatsAppButton>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12">
        <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
          ...
          <Button href="/contact?source=industry-section" variant="light">Get QR Catalogue Demo</Button>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12">
        <Card className="grid gap-6 bg-ink text-white lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            ...
            <Button href="/contact?source=footer-demo" variant="accent"><MessageCircle size={18} /> Get QR Catalogue Demo</Button>
          </div>
        </Card>
      </section>
