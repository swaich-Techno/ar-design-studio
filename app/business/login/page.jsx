...
export default function BusinessLoginPage() {
  return (
    <AuthShell eyebrow="Business owner workspace">
      <AuthForm role="BUSINESS_OWNER" title="Business Owner login" subtitle="Manage your own catalogue, QR codes, AR products, staff, and analytics." loginPath="/business/dashboard" />
