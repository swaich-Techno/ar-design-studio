...
export default async function PublicProductPage({ params, searchParams }) {
  ...
  const product = await Product.findOne({
    ...
    .select("name slug category price discountPrice description shortDescription imageUrl galleryImages modelGlbUrl modelUsdzUrl offerText tags isAvailable hasARModel stockStatus stockQuantity showStockToCustomers")
    .lean();
  if (!product) notFound();
