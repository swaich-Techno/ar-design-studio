...
export function AuthShell({ eyebrow, children }) {
  return (
    <main id="main-content" className="grid min-h-screen bg-surface px-5 py-8 lg:grid-cols-[0.92fr_1.08fr]">
      <header className="hidden rounded-[36px] bg-ink p-10 text-white lg:flex lg:flex-col lg:justify-between">
        <div>
          <Link href="/" className="grid h-14 w-14 place-items-center rounded-2xl bg-white text-ink" aria-label="AR Design Studio homepage">
            <ScanLine aria-hidden="true" focusable="false" />
          </Link>
