  ...
  return (
    <form onSubmit={submit} className="grid gap-4">
      ...
      <label className="form-label">
        Email address
        <input className="field" type="email" name="email" autoComplete="email" placeholder="Email address" value={email} onChange={(event) => setEmail(event.target.value)} required />
      </label>
