            ...
            <div key={business._id} className="rounded-[24px] border border-slate-200 bg-white p-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  {business.isFreeDemoApproved ? (
                    <p className="mt-2 rounded-full bg-teal-50 px-3 py-1 text-xs font-black text-teal-800">
                      Free demo approved: {business.demoProductLimit || 1} product / {business.demoArProductLimit || 1} AR slot{business.demoExpiresAt ? ` until ${new Date(business.demoExpiresAt).toLocaleDateString()}` : ""}
                    </p>
                  ) : null}
                </div>
