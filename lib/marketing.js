...
export const BRAND = {
  ...
  whatsappText: "Hi B Socio, I want to discuss an AR website, 3D product preview, QR catalogue, or interactive brand experience."
};

export const WHATSAPP_URL = `https://wa.me/${BRAND.phoneCompact}?text=${encodeURIComponent(BRAND.whatsappText)}`;

export const mainFeatures = [
  "AR website landing pages",
  "3D product preview",
  "Interactive campaign QR pages",
  ...
  "Campaign QR pages",
  "Analytics dashboard",
  "Mobile-friendly immersive design",
...
export const faqItems = [
  ["What does B Socio build with AR Design Studio?", "B Socio builds AR websites, 3D product preview pages, QR catalogues, interactive campaign pages, WhatsApp lead flows, and analytics-ready browser experiences."],
  ["Do customers need to install an app for web AR?", "No. The customer can open the experience in a mobile browser from a QR code, WhatsApp link, ad, social post, or product page."],
  ["Can you help with 3D models?", "Yes. Existing GLB and USDZ files can be connected to supported products, and the team can guide model optimization when a product needs a new 3D asset."],
...
export function softwareApplicationSchema() {
  return {
    ...
    operatingSystem: "Web",
    description: "AR Design Studio helps businesses create AR websites, 3D product previews, QR product catalogues, interactive campaign pages, WhatsApp enquiry flows, analytics, and mobile-first product landing pages.",
    offers: {
      "@type": "Offer",
      priceCurrency: "INR",
      price: "1999"
